...
.inv-split{{grid-template-columns:50% 50%;gap:14px;}}.inv-left .metrics-grid-4{{gap:6px;margin-bottom:6px;}}.inv-text p{{font-size:10px;line-height:1.4;margin-bottom:4px;}}.inv-logo{{width:140px;margin-top:6px;}}.inv-right{{padding-top:30px;}}.inv-photo{{height:170px;}}.inv-photo img{{-webkit-print-color-adjust:exact;print-color-adjust:exact;}}.inv-highlights{{padding:8px 12px;}}.inv-highlights h4{{font-size:10px;margin-bottom:3px;}}.inv-highlights li{{font-size:8.5px;line-height:1.25;margin-bottom:1px;}}
